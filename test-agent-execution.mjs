...
const secret=await gateway.dispatchAgentOperation(claimed.device.device_id,{op:"fs.read_head",args:{path:"/etc/shadow",bytes:64}});
if(secret.code===0) throw new Error("secret path was not denied");
console.log("AGENT_EXEC_SECRET_GUARD=PASS");
